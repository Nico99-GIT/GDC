...
CMAKE_SOURCE_DIR = /workspaces/GDC/build/_deps/result-subbuild

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /workspaces/GDC/build/_deps/result-subbuild
...
CMakeFiles/result-populate-complete: result-populate-prefix/src/result-populate-stamp/result-populate-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspaces/GDC/build/_deps/result-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'result-populate'"
	/usr/bin/cmake -E make_directory /workspaces/GDC/build/_deps/result-subbuild/CMakeFiles
	/usr/bin/cmake -E touch /workspaces/GDC/build/_deps/result-subbuild/CMakeFiles/result-populate-complete
	/usr/bin/cmake -E touch /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/src/result-populate-stamp/result-populate-done
...
result-populate-prefix/src/result-populate-stamp/result-populate-build: result-populate-prefix/src/result-populate-stamp/result-populate-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspaces/GDC/build/_deps/result-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "No build step for 'result-populate'"
	cd /workspaces/GDC/build/_deps/result-build && /usr/bin/cmake -E echo_append
	cd /workspaces/GDC/build/_deps/result-build && /usr/bin/cmake -E touch /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/src/result-populate-stamp/result-populate-build
...
result-populate-prefix/src/result-populate-stamp/result-populate-configure: result-populate-prefix/src/result-populate-stamp/result-populate-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspaces/GDC/build/_deps/result-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "No configure step for 'result-populate'"
	cd /workspaces/GDC/build/_deps/result-build && /usr/bin/cmake -E echo_append
	cd /workspaces/GDC/build/_deps/result-build && /usr/bin/cmake -E touch /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/src/result-populate-stamp/result-populate-configure
...
result-populate-prefix/src/result-populate-stamp/result-populate-download: result-populate-prefix/src/result-populate-stamp/result-populate-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspaces/GDC/build/_deps/result-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Performing download step (git clone) for 'result-populate'"
	cd /workspaces/GDC/build/_deps && /usr/bin/cmake -P /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/tmp/result-populate-gitclone.cmake
	cd /workspaces/GDC/build/_deps && /usr/bin/cmake -E touch /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/src/result-populate-stamp/result-populate-download
...
result-populate-prefix/src/result-populate-stamp/result-populate-install: result-populate-prefix/src/result-populate-stamp/result-populate-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspaces/GDC/build/_deps/result-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'result-populate'"
	cd /workspaces/GDC/build/_deps/result-build && /usr/bin/cmake -E echo_append
	cd /workspaces/GDC/build/_deps/result-build && /usr/bin/cmake -E touch /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/src/result-populate-stamp/result-populate-install

result-populate-prefix/src/result-populate-stamp/result-populate-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspaces/GDC/build/_deps/result-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'result-populate'"
	/usr/bin/cmake -Dcfgdir= -P /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/tmp/result-populate-mkdirs.cmake
	/usr/bin/cmake -E touch /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/src/result-populate-stamp/result-populate-mkdir
...
result-populate-prefix/src/result-populate-stamp/result-populate-patch: result-populate-prefix/src/result-populate-stamp/result-populate-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspaces/GDC/build/_deps/result-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'result-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/src/result-populate-stamp/result-populate-patch
...
result-populate-prefix/src/result-populate-stamp/result-populate-test: result-populate-prefix/src/result-populate-stamp/result-populate-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspaces/GDC/build/_deps/result-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No test step for 'result-populate'"
	cd /workspaces/GDC/build/_deps/result-build && /usr/bin/cmake -E echo_append
	cd /workspaces/GDC/build/_deps/result-build && /usr/bin/cmake -E touch /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/src/result-populate-stamp/result-populate-test
...
result-populate-prefix/src/result-populate-stamp/result-populate-update: result-populate-prefix/src/result-populate-stamp/result-populate-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/workspaces/GDC/build/_deps/result-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "Performing update step for 'result-populate'"
	cd /workspaces/GDC/build/_deps/result-src && /usr/bin/cmake -Dcan_fetch=YES -P /workspaces/GDC/build/_deps/result-subbuild/result-populate-prefix/tmp/result-populate-gitupdate.cmake
...
CMakeFiles/result-populate.dir/depend:
	cd /workspaces/GDC/build/_deps/result-subbuild && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspaces/GDC/build/_deps/result-subbuild /workspaces/GDC/build/_deps/result-subbuild /workspaces/GDC/build/_deps/result-subbuild /workspaces/GDC/build/_deps/result-subbuild /workspaces/GDC/build/_deps/result-subbuild/CMakeFiles/result-populate.dir/DependInfo.cmake "--color=$(COLOR)"
