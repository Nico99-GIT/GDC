...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v1.5.4"
  WORKING_DIRECTORY "/workspaces/GDC/build/_deps/arc-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v1.5.4\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/GDC/build/_deps/arc-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/GDC/build/_deps/arc-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
